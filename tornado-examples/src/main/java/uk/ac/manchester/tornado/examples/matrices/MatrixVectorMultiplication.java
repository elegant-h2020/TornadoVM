...
public class MatrixVectorMultiplication {
    ...
    public static void main(String[] args) {
        ...
        TaskGraph t = new TaskGraph("s0")
                .transferToDevice(DataTransferMode.EVERY_EXECUTION, matrixA, matrixB, matrixC, size)
                .task("t0", MatrixVectorMultiplication::matrixVectorMultiplication, matrixA, matrixB, matrixC, size)
                .transferToHost(DataTransferMode.EVERY_EXECUTION ,matrixC);
        //@formatter:on

        TornadoExecutionPlan tornadoExecutionPlan = new TornadoExecutionPlan(t.snapshot());
