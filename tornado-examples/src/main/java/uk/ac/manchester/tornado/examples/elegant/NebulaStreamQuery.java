 ...
 * </p>
 * <code>
 *     tornado --printKernel --threadInfo --jvm="-Ds0.t0.device=0:1 -Dtornado.recover.bailout=False -Dtornado.cim.mode=True" -m tornado.examples/uk.ac.manchester.tornado.examples.elegant.NebulaStreamQuery
 * </code>
 *
 */
